...
/**
 * Servlet implementation class DeleteBookTable
 */
@WebServlet(urlPatterns ="/DeleteBookTable")
public class DeleteBookTable extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            DBUtils.deleteBookTB(conn, bookId);
