...
/**
 * Servlet implementation class DeletePhanHoi
 */
@WebServlet(urlPatterns ="/DeletePhanHoi")
public class DeletePhanHoi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeletePhanHoi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            DBUtils.deletePhanHoi(conn, idphanhoi);
