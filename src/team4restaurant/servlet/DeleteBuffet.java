...
/**
 * Servlet implementation class DeleteBuffet
 */
@WebServlet(urlPatterns ="/DeleteBuffet")
public class DeleteBuffet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            DBUtils.deleteBuffet(conn, buffetId);
